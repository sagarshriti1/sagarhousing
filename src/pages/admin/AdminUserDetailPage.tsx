...
const joinLocation = (c: string, d: string) => [c, d].filter(Boolean).join(", ");
          ...
          <CardHeader>
            <div className="flex items-start justify-between gap-4 flex-wrap">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <CardTitle className="text-2xl">{profile.display_name || "Unnamed"}</CardTitle>
              ...
              <div className="flex flex-wrap gap-2">
                <Button variant="outline" size="sm" className="gap-2" onClick={openEdit}><Pencil className="h-4 w-4" /> Edit</Button>
                ...
                <Button variant="outline" size="sm" className="gap-2" onClick={handleToggleActive}>
                  {profile.is_active ? <><UserX className="h-4 w-4" /> Deactivate</> : <><UserCheck className="h-4 w-4" /> Activate</>}
                </Button>
              ...
              {userRole !== "realtor" && (() => {
                ...
                return (
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label>City</Label>
                      <Select value={l.city} onValueChange={(c) => setDraft({ ...draft, location: joinLocation(c, getDistrictForCity(c) || l.district) })}>
                    ...
                    <div>
                      ...
                      <Select value={l.district} onValueChange={(d) => setDraft({ ...draft, location: joinLocation(l.city, d) })}>
